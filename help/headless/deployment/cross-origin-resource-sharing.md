...
>[!CAUTION]
>
>Se [il caching in Dispatcher è stato abilitato](/help/headless/deployment/dispatcher-caching.md) quindi il filtro CORS non è necessario e questa sezione può essere ignorata.
