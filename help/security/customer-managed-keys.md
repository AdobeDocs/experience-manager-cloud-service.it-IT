...
* **Sicurezza avanzata:** i clienti possono garantire che le proprie procedure di crittografia soddisfano requisiti di sicurezza specifici, godendo della massima tranquillità rispetto alla protezione dei dati.
...
Adottando CMK, i clienti possono aumentare il controllo sulle loro pratiche di sicurezza e crittografia dei dati, migliorando la conformità e riducendo i rischi, il tutto pur continuando a godere della scalabilità e della flessibilità di AEM CS.
...
## Concedere l’accesso al Key Vault ad Adobe {#grant-adone-access-to-the-key-vault}
