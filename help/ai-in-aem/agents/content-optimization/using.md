...
* **[Collaborazione perfetta con Discovery Agent](/help/ai-in-aem/agents/discovery/using.md)**: si basa sulle risorse identificate da Discovery Agent, consentendo il recupero e l&#39;ottimizzazione end-to-end delle risorse tramite conversazione naturale.
...
Puoi accedere ad AEM Business Agent tramite l’Assistente AI. Accedere a experience.adobe.com e iniziare a interagire con l&#39;Assistente AI specificando il prompt nel linguaggio naturale utilizzando il campo `Ask AI Assistant anything`:
...
* **Creazione rappresentazione ad alta risoluzione**
  ...
  Cercare la risorsa corretta utilizzando l&#39;[agente di individuazione](/help/ai-in-aem/agents/discovery/using.md), quindi utilizzare i seguenti prompt in caso di più risultati di ricerca:
