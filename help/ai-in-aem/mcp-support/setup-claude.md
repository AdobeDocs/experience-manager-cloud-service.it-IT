...
![Finestra di dialogo Impostazioni Claude.](assets/claude-1.png)

![Pannello Connettori in Claude.](assets/claude-2.png)

![Aggiunta di un connettore personalizzato in Claude.](assets/claude-3.png)

![Connessione del connettore personalizzato in Claude.](assets/claude-4.png)

![Modulo di configurazione del connettore personalizzato in Claude.](assets/claude-5.png)

![Finestra di dialogo delle autorizzazioni dello strumento per il connettore personalizzato.](assets/claude-6.png)

![Richiesta a Claude di utilizzare il servizio MCP dei contenuti di AEM.](assets/claude-7.png)
