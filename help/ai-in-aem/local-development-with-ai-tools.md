...
| Componente | Scopo |
|---|---|
| **AGENTI.md** | Un file di contesto specifico per il progetto che basa l’intelligenza artificiale nel progetto AEM as a Cloud Service per ogni sessione |
