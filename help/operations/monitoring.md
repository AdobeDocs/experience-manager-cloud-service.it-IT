...
>[!NOTE]
>
> Questa funzionalità è disponibile solo per i clienti con supporto avanzato per il cloud. In caso di domande, solleva un caso di supporto tramite Admin Console.
