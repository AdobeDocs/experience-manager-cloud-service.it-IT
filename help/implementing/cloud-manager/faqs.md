...
Ulteriori dettagli sulla gestione delle versioni sono [documentati qui](/help/implementing/cloud-manager/managing-code/project-version-handling.md).
...
Nelle distribuzioni negli ambienti di staging e produzione, viene generata una versione automatica, come [documentato qui](/help/implementing/cloud-manager/managing-code/project-version-handling.md).
