...
| URL per i clienti per monitorare il programma di Cloud Service | Escluso | URL consigliato per il monitoraggio esterno della disponibilità.<br><br>`/system/probes/health` |
