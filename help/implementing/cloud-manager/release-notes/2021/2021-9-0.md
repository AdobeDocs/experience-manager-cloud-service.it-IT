...
* Le opzioni del menu della pagina Attività ora includono un’opzione per **Scarica registro** per le esecuzioni del generatore di codice completate. Selezionando questa opzione viene scaricato il registro della fase di build.

* Facendo direttamente clic sulla scheda Programma, ora si passa a **Panoramica** pagina. Per ulteriori informazioni, consulta [Creazione di un programma di produzione](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/implementing/using-cloud-manager/programs/creating-production-programs.html?lang=en).

### Correzioni di bug {#bug-fixes}

* L’utente visualizza ora un messaggio più comprensibile quando tenta di aggiungere un inserisco nell&#39;elenco Consentiti di IP in un programma nel quale è stato raggiunto il numero massimo consentito di elenchi Consentiti di IP configurabili.
