...
Se hai concesso la licenza ai Edge Delivery Services come parte di Adobe Experience Manager Sites, [ora puoi accedere al tuo sito con i Edge Delivery Services direttamente in Cloud Manager](/help/implementing/cloud-manager/edge-delivery/introduction-to-edge-delivery-services.md) e andare in diretta utilizzando un&#39;esperienza guidata e autonoma.

Le proprietà dell’AEM offrono ora un’esperienza unificata nei flussi di lavoro critici. Gli utenti traggono vantaggio dalla gestione coerente di nomi di dominio, certificati SSL e mappature CDN.
