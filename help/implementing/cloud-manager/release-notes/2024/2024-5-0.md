...
* La [Dashboard delle licenze](/help/implementing/cloud-manager/license-dashboard.md) è ora accessibile tramite un punto di ingresso distinto nella [navigazione](/help/implementing/cloud-manager/navigation.md) a sinistra.
