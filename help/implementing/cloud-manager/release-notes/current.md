...
* **Rinnovare manualmente i certificati di convalida del dominio gestito da Adobe**
  ...
  È ora possibile rinnovare manualmente i certificati DV (Adobe Managed Domain Validation) da Cloud Manager o dall&#39;API pubblica per aggiornare i certificati in modo proattivo. <!-- CMGR-68738 -->
