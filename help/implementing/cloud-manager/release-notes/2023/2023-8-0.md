...
* Durante la configurazione di un set di contenuti su [copia contenuto,](/help/implementing/developing/tools/content-copy.md) [le configurazioni in base al contesto](/help/implementing/developing/introduction/configurations.md) sono ora consentite nei set di contenuti nell&#39;interfaccia utente.
...
* Alla scadenza di un certificato, i nomi di dominio e gli elenchi IP consentiti associati al certificato non verranno più rimossi dalla rete CDN.
   ...
   * [L&#39;interfaccia utente di Cloud Manager](/help/implementing/cloud-manager/managing-ssl-certifications/introduction.md) fornirà avvisi anticipati più visibili sulla prossima scadenza del certificato SSL.
