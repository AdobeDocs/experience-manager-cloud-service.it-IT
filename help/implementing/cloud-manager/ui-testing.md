...
>[!NOTE]
>Se il progetto non include la riga, dovrai modificare questo file per abilitare il consenso al test dell’interfaccia utente. Se il file ha una riga che consiglia di non modificare, si prega di ignorare quel consiglio.
