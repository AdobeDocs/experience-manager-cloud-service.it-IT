...
Le limitazioni di questo silo naturale sono evidenti in quanto si rende conto di quanto sforzo e tempo è necessario per coordinare le modifiche tra tutti i componenti dello stack.

Gli utenti si aspettano un coinvolgimento indipendentemente dalla piattaforma o dal punto di contatto, il che richiede flessibilità nella distribuzione delle esperienze.  Questo approccio multicanale è lo standard delle esperienze digitali e un approccio completo può talvolta risultare inflessibile.
...
Omettendo la testa si semplifica notevolmente il CMS eliminando la complessità sostanziale. In questo modo si sposta anche la responsabilità di rendere i contenuti ai servizi che ne hanno effettivamente bisogno e che sono spesso più adatti a tale rendering.
...
E c’è ancora bisogno di API REST affidabili. Tuttavia le richieste REST possono essere grandi e complesse. Se hai più consumatori che fanno chiamate REST per tutti i tuoi canali, questo composti di verbosità e le prestazioni possono essere influenzate.
...
In qualità di leader di settore nella gestione dell&#39;esperienza digitale, Adobe si rende conto che la soluzione ideale per affrontare una vera sfida che i creatori di esperienze affrontano raramente è una scelta binaria. Questo è il motivo per cui AEM supporta non solo entrambi i modelli, ma consente anche unicamente la combinazione ibrida senza soluzione di continuità tra i due per aiutarvi a servire al meglio i consumatori dei vostri contenuti. Ovunque siano.

Questo percorso si concentra sul modello di distribuzione dei contenuti headless. Tuttavia, una volta gettate questa base di conoscenza, potete esplorare ulteriormente come sfruttare il potere di entrambi i modelli.
