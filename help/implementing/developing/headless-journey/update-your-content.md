...
Nel documento precedente del percorso AEM headless, [Come accedere ai contenuti tramite API di consegna AEM](access-your-content.md) hai imparato ad accedere ai contenuti headless in AEM tramite API e ora devi:

* Scopri cos’è GraphQL e come funziona AEM’API GraphQL.
* Comprendere alcune domande pratiche di esempio.

Questo articolo si basa su questi elementi fondamentali per comprendere come aggiornare il contenuto headless esistente in AEM tramite API.
...
* **Obiettivo**: Scopri come utilizzare l’API REST per accedere e aggiornare il contenuto dei frammenti di contenuto:
   ...
   * Osserva il codice di esempio per vedere come funzionano le cose in pratica.
...
* Scopri in che modo i frammenti di contenuto sono supportati nell’API.
* Acquisisci esperienza con il codice di esempio e scopri come funziona in pratica l’API.
