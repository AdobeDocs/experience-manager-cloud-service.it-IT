...
description: In un’area SPA, il componente pagina non fornisce gli elementi HTML dei componenti secondari, ma lo delega al framework SPA. In questo documento viene illustrato come questo rende univoco il componente di pagina di un’area speciale.
