...
+ Authoring {#authoring}
   ...
   + Nozioni di base sull’authoring {#fundamentals}
      ...
      + [Creazione di un nuovo sito](authoring/fundamentals/create-site.md)
      ...
      + [Anteprima del contenuto](authoring/fundamentals/previewing-content.md)
      ...
      + [Frammenti di esperienza](authoring/fundamentals/experience-fragments.md)
   ...
   + Progetti {#projects}
      ...
      + [Utilizzo dei flussi di lavoro per i progetti](authoring/projects/workflows.md)
   + Lanci {#launches}
      + [Utilizzo dei lanci](authoring/launches/overview.md)
      + [Creazione dei lanci](authoring/launches/creating.md)
      ...
      + [Promozione dei lanci](authoring/launches/promoting.md)
   ...
   + Personalizzazione {#personalization}
      ...
      + [Visualizzare l’anteprima delle pagine utilizzando i dati di ContextHub](authoring/personalization/contexthub.md)
      + [Creazione di contenuti di destinazione utilizzando la modalità di targeting](authoring/personalization/targeted-content.md)
      + [Utilizzo dei contenuti di destinazione in più siti](authoring/personalization/multisite-targeted-content.md)
...
+ Amministrazione {#administering}
   + Creazione di siti {#site-creation}
      + [Creazione di un nuovo sito](administering/site-creation/create-site.md)
      + [Modelli per siti](administering/site-creation/site-templates.md)
      + [Temi del sito](administering/site-creation/site-themes.md)
   ...
   + Riutilizzo del contenuto {#reusing-content}
      ...
      + Traduzione {#translation}
         + [Percorso della documentazione di traduzione](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/sites-journey/translation/overview.html)
