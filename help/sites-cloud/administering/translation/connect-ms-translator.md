...
1. Nella finestra **Modifica configurazione**, seleziona **Aggiorna sottoscrizione**. Si aprirà una pagina web Microsoft con ulteriori dettagli sul servizio.
...
1. Seleziona la configurazione di Microsoft Translator esistente.
1. Seleziona **Modifica**.
1. Nella finestra **Modifica configurazione**, seleziona **Personalizza Translator**. Utilizza la pagina web Microsoft che si apre per personalizzare il tuo servizio.
