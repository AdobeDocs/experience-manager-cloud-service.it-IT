...
* [Usa IA per la generazione di varianti](#generate-variations-ai) utilizzare l’intelligenza artificiale generativa per utilizzare un modello basato su prompt creato da Adobe per un caso d’uso specifico.
