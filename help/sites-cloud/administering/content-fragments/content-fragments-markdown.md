...
Quando sei [authoring](/help/sites-cloud/administering/content-fragments/content-fragments-variations.md#authoring-your-content), l’editor dei frammenti di contenuto utilizza *markdown* per consentire di scrivere facilmente contenuti sia per l’authoring delle pagine che per la distribuzione headless:

![editor markdown](/help/sites-cloud/administering/content-fragments/assets/cfm-markdown-01.png)

Puoi definire:

* [Notazione titolo](/help/sites-cloud/administering/content-fragments/content-fragments-markdown.md#heading-notation)
...
* [Virgolette a blocchi](/help/sites-cloud/administering/content-fragments/content-fragments-markdown.md#block-quotes)
