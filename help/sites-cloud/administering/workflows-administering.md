...
Per configurare il servizio, puoi configurare i file di configurazione OSGI e vedere i file [di configurazione](/help/implementing/deploying/configuring-osgi.md)OSGi. Nella tabella seguente sono descritte le proprietà necessarie per entrambi i metodi.
