...
| [Note sulla versione](/help/release-notes/home.md) | Questa guida fornisce informazioni importanti sulla versione più recente di Experience Manager as a Cloud Service, incluse le novità, funzionalità obsolete e rimosse e i problemi noti. |
...
| [Percorso per sviluppatori headless](/help/journey-headless/developer/overview.md) | Esplora questo percorso guidato attraverso le potenti e flessibili funzionalità headless di AEM per prepararti al tuo primo progetto headless. |
...
* [Documentazione di HTL](https://experienceleague.adobe.com/docs/experience-manager-htl/content/overview.html?lang=it)
