...
>[!CAUTION]
>
>La configurazione descritta in questa pagina non può più essere utilizzata per integrazioni nuove o aggiornate.
>
...
>
>Le configurazioni precedenti, come descritto in questa pagina, sono state effettuate con [Credenziali JWT ora obsolete nella console Adobe Developer](/help/security/jwt-credentials-deprecation-in-adobe-developer-console.md).
...
* L’amministratore di sistema della tua organizzazione deve utilizzare l’Admin Console per aggiungere gli sviluppatori necessari ai profili di prodotto pertinenti.
   ...
   * Consulta [Gestisci sviluppatori](https://helpx.adobe.com/it/enterprise/admin-guide.html/enterprise/using/manage-developers.ug.html).
...
Alcune di queste sono necessarie per completare l’integrazione di Adobe Analytics nell’AEM basato su IMS.
