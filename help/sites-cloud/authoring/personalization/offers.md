...
1. Seleziona **Crea** > **Crea cartella o offerta**.
...
1. Nella parte superiore della console Offerte, seleziona l’icona della lente di ingrandimento. Per impostazione predefinita, la ricerca è limitata alle offerte.
