...
1. Dopo aver [effettuato l’accesso ai segmenti](#accessing-segments), [andate alla cartella](#organizing-segments) in cui desiderate creare il segmento, oppure lasciatelo nella directory principale.
