...
Utilizza la [Console Attività](/help/sites-cloud/authoring/personalization/activities.md) per creare e gestire le attività dei brand. Puoi anche creare attività mentre [contenuto di destinazione dell&#39;autore](/help/sites-cloud/authoring/personalization/targeted-content.md).
...
Ad esempio, la pagina femminile di un sito web di esempio può utilizzare le offerte come immagine teaser che appare nella parte superiore della pagina. Le offerte utilizzate come teaser sono diverse per l&#39;esperienza Donna Over 30 e per l&#39;esperienza Donna Under 30.
...
Puoi utilizzare questo motore quando ti sei integrato con Adobe Target. <!--You can use this engine when you have [integrated with Adobe Target](/help/sites-administering/opt-in.md).-->
