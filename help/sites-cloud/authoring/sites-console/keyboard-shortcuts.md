...
|  | `/` | Avvia la [ricerca](/help/sites-cloud/authoring/search.md) |
|  | `Alt+`&lt;`Number`> | Consente di selezionare l’opzione del [selettore della barra](/help/sites-cloud/authoring/basic-handling.md#rail-selector) da visualizzare |
|  | ``` ` ``` | Nasconde la barra |
|  | `e` | Modifica |
|  | `p` | Proprietà |
|  | `m` | Sposta |
...
* [Preferenze](/help/sites-cloud/authoring/account-environment.md#my-preferences)
* [Menu Aiuto](/help/sites-cloud/authoring/basic-handling.md#accessing-help)
...
Alcune scelte rapide da tastiera sono applicabili alla [Console Frammenti di contenuto](/help/sites-cloud/administering/content-fragments/keyboard-shortcuts.md)