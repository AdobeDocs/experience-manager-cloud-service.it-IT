...
* **Impostazioni modello**
   ...
   * **Modelli permessi**: [definisce l’elenco di modelli che sono disponibili](/help/sites-cloud/authoring/sites-console/templates.md#enabling-and-allowing-a-template-template-author) in questo ramo secondario
...
>[!NOTE]
>
>Consulta [Abilitazione delle funzioni progressive delle app web](/help/sites-cloud/authoring/sites-console/enable-pwa.md).
