...
* Viene visualizzata la barra degli strumenti. Seleziona Clona.
   ...
   * Il **Titolo lancio** indicherà che si tratta di un clone. È possibile aggiornare il titolo modificando la [Configurazione lancio](/help/sites-cloud/authoring/launches/editing.md#editing-a-launch-configuration) (**Proprietà**).
