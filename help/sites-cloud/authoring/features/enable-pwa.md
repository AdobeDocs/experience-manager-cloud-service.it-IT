...
Invece di richiedere una nuova codifica del sito, un autore di contenuti può configurare le proprietà di PWA come scheda aggiuntiva nel [proprietà pagina](/help/sites-cloud/authoring/fundamentals/page-properties.md) di un sito.
