...
Anziché richiedere una nuova codifica del sito, un autore di contenuti può configurare le proprietà di PWA come scheda aggiuntiva nelle [proprietà pagina](/help/sites-cloud/authoring/fundamentals/page-properties.md) di un sito.
...
>[!NOTE]
>
>Le app web progressive sono una tecnologia in evoluzione e supportano l’installazione di app locali e altre funzioni [in base al browser utilizzato.](https://developer.mozilla.org/en-US/docs/Web/Progressive_web_apps/Tutorials/js13kGames/Installable_PWAs#summary)
...
1. Selezionare il progetto Sites e selezionare [**Proprietà**](/help/sites-cloud/authoring/fundamentals/page-properties.md) oppure utilizzare il tasto di scelta rapida `p`.
