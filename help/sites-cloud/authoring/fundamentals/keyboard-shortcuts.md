...
|---|---|---|
| Qualsiasi modalità delle finestre di modifica | `Ctrl-Shift-m` | Passa da **Anteprima** e la [modalità](/help/sites-cloud/authoring/fundamentals/environment-tools.md#page-modes)</a> (ad esempio, **Modifica**, **Layout**, ecc.* |
