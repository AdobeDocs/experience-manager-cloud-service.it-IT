...
* The [configuration](/help/sites-cloud/authoring/fundamentals/editing-content.md#component-toolbar) dialog for specific components (using the ? nella barra degli strumenti della finestra di dialogo), che mostra la guida sensibile al contesto
...
I componenti sono gli elementi costitutivi del contenuto AEM. Posizionate più componenti su una pagina e configurate le relative opzioni per creare la pagina dei contenuti con AEM.
...
The components browser is a tab within the side panel (together with the [assets browser](#assets-browser) and [content tree](#content-tree)). Per aprire (o chiudere) il pannello laterale utilizza l’icona in alto a sinistra della barra degli strumenti:
...
* **Dispositivo desktop**
   ...
   * limitare la visualizzazione a uno specifico gruppo selezionandolo dall&#39;elenco a discesa.
   ...
   ![Informazioni sul browser dei componenti](/help/sites-cloud/authoring/assets/component-browser-information.png)
...
The assets browser is a tab within the side panel along with the [components browser](#components-browser) and [content tree](#content-tree). Per aprire (o chiudere) il pannello laterale utilizza l’icona in alto a sinistra della barra degli strumenti:
...
Poiché una pagina può essere composta facilmente da molti dei componenti dello stesso tipo, la struttura ad albero del contenuto (componente) presenta un testo descrittivo (in grigio) dopo il nome del tipo di componente (in nero). Il testo descrittivo è composto dalle proprietà comuni del componente, come ad esempio il titolo o il testo.
...
![Espansione con albero contenuto](/help/sites-cloud/authoring/assets/content-tree-chevron.png)
...
* Ad esempio, una pagina base:
   ...
   ![Pulsante Modifica albero contenuto](/help/sites-cloud/authoring/assets/content-tree-edit.png)
...
![Riferimenti, opzione](/help/sites-cloud/authoring/assets/references.png)
...
* [Avvii](/help/sites-cloud/authoring/launches/overview.md), consente di accedere ai relativi avvii
...
![Dettagli della timeline](/help/sites-cloud/authoring/assets/timeline-detail.png)
...
![Informazioni pagina, opzione](/help/sites-cloud/authoring/assets/page-information.png)
...
* [Layout](/help/sites-cloud/authoring/features/responsive-layout.md) : consente di creare e modificare il layout reattivo a seconda del dispositivo (se la pagina è basata su un contenitore di layout)
...
I campi percorso dispongono ora della funzione di auto-completamento e di look ahead per semplificare l’individuazione di una risorsa.
...
![Apri finestra di dialogo di selezione](/help/sites-cloud/authoring/assets/open-selection-dialog-button.png)

Oppure puoi iniziare a digitare nel campo percorso e AEM fornirà i percorsi corrispondenti mentre digiti.

![Apri finestra di dialogo di selezione](/help/sites-cloud/authoring/assets/path-selection-completion.png)
...
* Per limitare l’ambito della ricerca, puoi visualizzare le opzioni filtro e filtrare il risultato in base a un determinato percorso.
   ...
   ![Filtri, opzione](/help/sites-cloud/authoring/assets/filters-option.png)
