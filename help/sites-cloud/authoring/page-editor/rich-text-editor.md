...
Seleziona un componente basato su testo con un solo clic per visualizzare la [barra degli strumenti del componente](/help/sites-cloud/authoring/page-editor/editor-side-panel.md#components-browser).
