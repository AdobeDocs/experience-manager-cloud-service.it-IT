...
* SITES-20149: RTC: `[cq-wcm-launches-core]` Esporta nuova API per i lanci per i FC.
* SITES-20150: RTC: `[cq-command]` Aggiungere nuovi metodi all&#39;API esistente.
...
* SITES-20342: `[Backend]` Pubblicazione a livello di cartella - Aggiungi filtro solo per CF di pubblicazione.
...
* SITES-20656: `[BE]` Specificare l&#39;opzione che consente di usare maiuscole e minuscole in caso di sostituzione di una stringa.
* SITES-20666: i test devono essere disattivati per impostazione predefinita durante l’authoring.
* SITES-20752: `[cq-wcm-core]` avvii di Apple per i FC.
...
* SITES-20947: `[persistence]` recupera l&#39;attività secondaria per ID frammento di contenuto.
...
* SITES-21044: `[CF][launches]` implementazione asincrona della modifica del payload della porta laterale in Cloud Service.
...
* SITES-11727: `[GQL]` Dati mancanti nell&#39;idratazione completa dei riferimenti ai frammenti di contenuto.
...
* SITES-21233: `[CoreCmp]` Pannello a soffietto danneggiato per GS1 US dopo l&#39;aggiornamento a 15860.
