...
- SITES-12573 - Se non viene specificata una variabile, le query GraphQL che utilizzano variabili all’interno di un filtro hanno esito negativo. Non aggiornare a questa versione utilizzerà GraphQL con AEM as a Cloud Service.
