...
- GRANITE-46601 - L’SDK Quickstart non si avvia su jdk 11.0.20 senza `-Djdk.util.zip.disableZip64ExtraFieldValidation=true` Java™, opzione
...
- FORMS-8500: nel browser Microsoft® Edge con l’opzione IE Mode abilitata, l’apertura di HTML5 Forms non riesce.
