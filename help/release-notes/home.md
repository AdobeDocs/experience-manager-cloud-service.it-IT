---
title: Note sulla versione per Adobe Experience Manager (AEM) come servizio Cloud.
description: 'Note sulla versione per Adobe Experience Manager (AEM) come servizio Cloud. '
...
| Prodotto | Adobe Experience Manager come servizio cloud |
|---|---|
| Versione | 2020.01.0 |
| Tipo | Aggiornamento continuo |
| Data disponibilità | Aggiornamento continuo |

## Informazioni sulla versione chiave {#key-articles}

* [Novità](what-is-new.md)
* [Modifiche principali](aem-cloud-changes.md)
