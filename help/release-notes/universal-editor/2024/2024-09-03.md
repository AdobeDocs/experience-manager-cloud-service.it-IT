...
* **Selezione basata sull’estensione**: [gli sviluppatori di estensioni](/help/implementing/universal-editor/customizing.md#extending) possono ora selezionare gli elementi di contenuto a livello di programmazione.
