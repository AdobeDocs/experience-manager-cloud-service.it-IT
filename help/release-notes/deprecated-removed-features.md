...
>title="Funzioni obsolete e rimosse in AEM come Cloud Service"
>abstract="AEM come Cloud Service dispone di un modello di distribuzione nativo per il cloud. Alcune funzionalità sono state sostituite da controparti native per il cloud e questa scheda mostra tali funzioni."
...
| [!DNL Foundation] | Interfaccia utente di replica ad albero nella scheda &quot;Distribute&quot; dell’agente di replica (rimozione dopo il 30 settembre 2021) | [Gestisci approcci ](/help/operations/replication.md#manage-publication) al flusso di lavoro per la  [pubblicazione o la pubblicazione della struttura del contenuto ](/help/operations/replication.md#publish-content-tree-workflow)  |
...
Consulta [questa pagina](/help/release-notes/deprecated-apis.md) per informazioni su eventuali API Java obsolete o rimosse, che vengono talvolta introdotte.
