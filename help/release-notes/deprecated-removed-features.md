...
>[!IMPORTANT]
>
>Diverse [API obsolete](#aem-apis) verranno rimosse il **11 giugno 2026**. Rivedi le date e gli impatti principali:
>
...
| [!DNL Sites] | Frammenti di contenuto semplici basati su modelli. | [Frammenti di contenuti strutturati basati su modelli](/help/assets/content-fragments/content-fragments-models.md) ora. |
...
Se si utilizza ACS AEM Commons, utilizzare almeno la versione 6.17.2 (si consiglia l&#39;ultima versione) e assicurarsi di [includere la versione per Cloud Service](https://adobe-consulting-services.github.io/acs-aem-commons/pages/maven.html) specificando il classificatore `cloud` per il pacchetto di contenuti.
...
* Se utilizzi ACS AEM Commons, aggiorna alla versione più recente (almeno 6.17.2) e assicurati di utilizzare il classificatore `cloud`.
...
* Se utilizzi ACS AEM Commons, aggiorna alla versione più recente (almeno 6.17.2) e assicurati di utilizzare il classificatore `cloud`.
* Se utilizzi `io.wcm:io.wcm.caconfig.extensions`, devi aggiornarlo almeno alla versione 1.9.2
