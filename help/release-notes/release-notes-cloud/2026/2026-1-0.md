...
# Note sulla versione 2026.1.0 di [!DNL Adobe Experience Manager] as a Cloud Service {#release-notes}

La sezione seguente illustra le note sulla versione funzionale 2026.1.0 di [!DNL Experience Manager] as a Cloud Service.
