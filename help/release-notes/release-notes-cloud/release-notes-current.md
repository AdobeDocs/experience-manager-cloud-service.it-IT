...
* AEM progetto Archetype per Forms as a Cloud Service ora include [modelli di dati modulo per Microsoft Dynamics e Salesforce.com](https://experienceleague.adobe.com/docs/experience-manager-forms-cloud-service/forms/setup-environment/setup-local-development-environment.html?#forms-cloud-service-local-development-environment).

* **Documento di registrazione** basato su Acroform: AEM Forms as a Cloud Service supporta l’utilizzo di  [Adobe Acrobat Form PDF (Acroform PDF)](https://experienceleague.adobe.com/docs/experience-manager-forms-cloud-service/forms/create-an-adaptive-form/generate-document-of-record-for-non-xfa-based-adaptive-forms.html)  come modello per Document of Record oltre a modelli di modulo basati su XFA.

* **Connettore** archivio dati di Microsoft Azure: È ora possibile  [collegare il modello dati modulo all’archiviazione](https://experienceleague.adobe.com/docs/experience-manager-forms-cloud-service/forms/use-form-data-model/configure-azure-storage.html) Microsoft Azure. Consente di recuperare e archiviare dati adattivi del modulo in Microsoft Azure Storage as a BLOB.
