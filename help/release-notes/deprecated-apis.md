...
<tbody>
  ...
  <tr>
    <td>org.json</td>
    <td>L'attuazione di Apache Johnzon <a href="https://johnzon.apache.org/index.html">javax.json</a> è consigliato e deve essere utilizzato. </td>
    <td>30/04/21</td>
    <td>31/12/21</td>
  </tr>
  <tr>
    <td>org.apache.felix.cm<br>org.apache.felix.cm.file</td>
    <td>I gestori di persistenza personalizzati non sono supportati in AEM as a Cloud Service.</td>
    <td>30/04/21</td>
    <td>rimossa</td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td>L'utilizzo di questa API non è supportato in AEM as a Cloud Service.</td>
    <td>27/05/21</td>
    <td>30/07/21</td>
  </tr>
  <tr>
