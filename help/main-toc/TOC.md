...
+ Sicurezza {#security}
   ...
   + [Best practice per la mappatura degli utenti e la definizione degli utenti del servizio Sling](/help/security/best-practices-for-sling-service-user-mapping-and-service-user-definition.md)
