...
1. Selezionare il **Riferimento frammento** nella scheda **Base**. Vengono visualizzati tutti i frammenti di Forms adattivo disponibili per il modulo, a seconda del modello del modulo.
