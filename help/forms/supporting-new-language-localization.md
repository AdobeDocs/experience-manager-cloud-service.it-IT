---
title: Aggiunta del supporto per nuove lingue a un modulo adattivo
...
1. [Aggiunta del supporto per la localizzazione per le lingue non supportate](#add-localization-support-for-non-supported-locales-add-localization-support-for-non-supported-locales)
1. [Utilizzare le lingue aggiunte in Adaptive Forms](#use-added-locale-in-adaptive-forms-use-added-locale-in-af)
...
1. [Aggiungere una lingua al servizio GuideLocalizationService](#2-add-a-locale-to-the-guide-localization-service-add-a-locale-to-the-guide-localization-service-br)
1. [Aggiungi cartella specifica per il nome della lingua](#3-add-locale-name-specific-folder-client-library-add-locale-name-specific-folder)
1. [Aggiungere il supporto delle impostazioni locali per il dizionario](#about-locale-dictionaries-about-locale-dictionaries)
1. [Eseguire il commit delle modifiche nell’archivio e distribuire la pipeline](#5-commit-the-changes-in-the-repository-and-deploy-the-pipeline-commit-chnages-in-repo-deploy-pipeline)
...
#### 2. Aggiungere una lingua al servizio di localizzazione della Guida TV {#add-a-locale-to-the-guide-localization-service-br}
...
##### 3.2. Aggiungere la libreria client di Moduli adattivi per una cartella dei nomi delle impostazioni locali {#add-adaptive-form-client-library-for-a-locale-br}
...
#### 4. Aggiungere il supporto delle impostazioni internazionali per il dizionario {#add-locale-support-for-the-dictionary-br}
...
#### 5. Eseguire il commit delle modifiche nell’archivio e distribuire la pipeline {#commit-chnages-in-repo-deploy-pipeline}
