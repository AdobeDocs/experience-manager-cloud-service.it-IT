...
## AEM Forms può essere utilizzato sia per i processi assicurativi interni che per quelli rivolti ai clienti?

Sì. AEM Forms supporta moduli digitali rivolti ai clienti e processi interni, basati su personale o agenti, come revisioni, approvazioni e acquisizione assistita dei dati.

## AEM Forms può essere utilizzato per l’invio di richieste di indennizzo assicurativo?

Sì. AEM Forms supporta moduli adattivi in più fasi che consentono agli assicurati di inviare le richieste di indennizzo in formato digitale, inclusa l’acquisizione di dati strutturati e di documentazione di supporto.

## AEM Forms supporta le richieste di rimborso per le assicurazioni mobili?

Sì. AEM Forms supporta moduli dinamici e facili da usare sui dispositivi mobili, consentendo a clienti e agenti di inviare informazioni assicurative da dispositivi mobili.
