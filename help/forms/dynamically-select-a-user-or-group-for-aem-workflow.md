---
title: Come selezionare gli utenti in AEM Workflow?
...
1. Carica il bundle in un server [!DNL AEM Forms]. È possibile utilizzare Gestione pacchetti di AEM per importare il bundle nel server [!DNL AEM Forms].
