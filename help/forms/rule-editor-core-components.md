...
Immagina un modulo con un pannello ripetibile. Ogni istanza del pannello potrebbe raccogliere dati come quantità di prodotto. È possibile utilizzare la funzione Somma per calcolare automaticamente la quantità totale in tutti i pannelli, eliminando i calcoli manuali e i potenziali errori.
