...
Se non installi il server AEM su un percorso contestuale, le regole proxy a livello di Apache saranno le seguenti:
...
* Utilizza l&#39;API `[unloadAdaptiveForm](https://developer.adobe.com/experience-manager/reference-materials/6-5/forms/javascript-api/GuideBridge.html)` per scaricare il modulo adattivo dal DOM di HTML.
