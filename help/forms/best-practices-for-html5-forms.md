...
* Attiva la compressione Web. Riduce la dimensione delle richieste e delle risposte generate da un modulo. <!-- For details, see [Performance tuning of AEM Forms Server](https://helpx.adobe.com/it/aem-forms/6-3/performance-tuning-aem-forms.html)-->
