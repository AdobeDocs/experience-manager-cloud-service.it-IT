...
description: Scopri come creare una configurazione di archiviazione BLOB di Azure in AEM Forms e utilizzarla nel Forms adattivo per un’archiviazione dei dati efficiente.
