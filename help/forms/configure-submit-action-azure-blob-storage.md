---
title: Come collegare AEM Adaptive Forms con l’archiviazione BLOB di Azure?
description: Scopri come creare una configurazione di archiviazione BLOB di Azure in AEM Forms e utilizzarla nel tuo Forms adattivo per un’archiviazione dei dati efficiente.
keywords: Integrazione dell’archiviazione BLOB di Azure con AEM Forms, invio dei dati all’archiviazione Azure, creazione della configurazione di archiviazione Azure in AEM Forms, utilizzo dell’archiviazione BLOB di Azure in un’azione di invio Adaptive Forms
...
L&#39;azione di invio **[!UICONTROL Invia ad Azure Blob Storage]** collega un modulo adattivo a un portale Microsoft® Azure. Puoi inviare i dati del modulo, i file, gli allegati o il documento record ai contenitori di archiviazione Azure collegati.
...
Alcuni dei vantaggi dell’integrazione dell’archiviazione BLOB di Azure con AEM Forms sono:

* Consente di semplificare il processo di invio di dati, file, allegati e documenti del modulo adattivo ai contenitori di archiviazione Azure.
* Utilizza l’archiviazione BLOB di Azure per l’archiviazione centralizzata e organizzata degli invii di moduli adattivi.

## Collegare AEM Forms con l’archiviazione BLOB Microsoft® Azure

Per utilizzare l’archiviazione BLOB di Azure nell’azione di invio di Adaptive Forms:
...
2. [Utilizza la configurazione di archiviazione Azure in un modulo adattivo](#use-azure-storage-configuration-in-an-adaptive-form-use-azure-storage-configuartion-in-af): collega il modulo adattivo ai contenitori di archiviazione Azure configurati.

### Creare un contenitore di archiviazione BLOB di Azure {#create-azure-configuration}

Per collegare AEM Forms ai contenitori di archiviazione Azure:

1. Vai all&#39;**istanza Autore AEM Forms** > **[!UICONTROL Strumenti]** > **[!UICONTROL Servizi cloud]** > **[!UICONTROL Archiviazione Azure]**.
1. Dopo aver selezionato **[!UICONTROL Azure Storage]**, sei reindirizzato a **[!UICONTROL Azure Storage Browser]**.
...
1. Specifica il **[!UICONTROL titolo]**, **[!UICONTROL account di archiviazione Azure]** e la **[!UICONTROL chiave di accesso Azure]**.
...
1. Dall&#39;elenco a discesa **[!UICONTROL Invia azione]**, selezionare **[!UICONTROL Invia ad Azure Blob Storage]**.
   ...
   ![GIF archiviazione BLOB di Azure](/help/forms/assets/submit-to-azure-blob-fc.png){width=50%,height=50%}
...
Quando invii il modulo, i dati vengono salvati nella configurazione del contenitore di archiviazione Azure specificata.
...
1. Fai clic sulla scheda **Invio** e seleziona **[!UICONTROL Invia ad Azure Blob Storage]** azione di invio.
   ![Archiviazione BLOB Azure](/help/forms/assets/azure-blob-storage-ue.png)
