---
title: AEM Forms as a Cloud Service supporta i font pronti all’uso per la generazione PDF.
description: AEM Forms as a Cloud Service supporta font pronti all’uso per documenti di record e PDF.
...
* To generate Document of Record to archive AEM forms and content together in PDF format ([Click to know more](https://experienceleague.adobe.com/it/docs/experience-manager-cloud-service/content/forms/adaptive-forms-authoring/authoring-adaptive-forms-foundation-components/generate-document-of-record-for-non-xfa-based-adaptive-forms)).
-->
...
Oltre ai tipi di carattere sopra indicati, è possibile utilizzare tipi di carattere personalizzati per conferire ai PDF un aspetto specifico. Per abilitare i font personalizzati, [aggiungi font personalizzati al tuo ambiente Forms as a Cloud Service](/help/forms/use-custom-fonts.md) con una licenza valida.
