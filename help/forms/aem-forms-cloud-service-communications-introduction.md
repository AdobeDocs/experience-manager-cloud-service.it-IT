...
**Le API di manipolazione dei documenti sono in fase di pre-rilascio e sono soggette a modifiche prima della versione effettiva.**
...
## Manipolazione dei documenti (pre-release)
