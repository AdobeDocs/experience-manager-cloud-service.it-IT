...
1. Fai clic su **[!UICONTROL Aggiungi gestore di successo]**. Verrà aperto l&#39;editor di regole **[!UICONTROL Richiama gestore di successo del servizio]**.
1. Nella sezione **[!UICONTROL Then]** aggiungere una regola per impostare il valore di **[!UICONTROL Pet Name]** su **`name`** utilizzando i dati eventpayload.
1. Fai clic su **[!UICONTROL Fine]** per chiudere l&#39;editor **[!UICONTROL Richiama gestore di successo del servizio]**.
1. Fare clic su **[!UICONTROL Aggiungi gestore errori]**. Verrà aperto l&#39;editor di regole **[!UICONTROL Richiama gestore errori servizio]**.
1. Nella sezione **[!UICONTROL Then]** selezionare **[!UICONTROL Output funzione]** e scegliere **[!UICONTROL Gestore errori predefinito]**.
1. Fai clic su **[!UICONTROL Fine]** per chiudere l&#39;editor **[!UICONTROL Richiama gestore errori servizio]**.
...
1. [Clona il tuo archivio AEM Forms as a Cloud Service](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/onboarding/journey/developers.html?lang=en#accessing-git).
...
1. Fai clic su **[!UICONTROL Fine]** per chiudere l&#39;editor **[!UICONTROL Richiama gestore di successo del servizio]**.
1. Fare clic su **[!UICONTROL Aggiungi gestore errori]**. Verrà aperto l&#39;editor di regole **[!UICONTROL Richiama gestore errori servizio]**.
1. Nella sezione **[!UICONTROL Then]** selezionare **[!UICONTROL Output funzione]** e scegliere **[!UICONTROL Funzione gestore errori personalizzato]**.
1. Fai clic su **[!UICONTROL Fine]** per chiudere l&#39;editor **[!UICONTROL Richiama gestore errori servizio]**.
1. Fai clic su **[!UICONTROL Fine]** per salvare la regola.
