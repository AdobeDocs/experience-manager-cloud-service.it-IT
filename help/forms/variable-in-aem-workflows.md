...
1. Selezionare il tipo di dati dall&#39;elenco a discesa **[!UICONTROL Tipo]** e specificare i valori seguenti:
   ...
   * Modello dati modulo (FDM): specifica il percorso di un modello dati modulo.
   * ArrayList - Specificare un sottotipo per la raccolta.

1. Specifica una descrizione facoltativa per la variabile e seleziona ![Icona_fine](assets/Smock_Checkmark_18_N.svg) per salvare le modifiche. La variabile viene visualizzata nell’elenco disponibile nel riquadro a sinistra.
...
* **Valore letterale:** Utilizzare l&#39;opzione quando si conosce il valore esatto da specificare. È inoltre possibile utilizzare l’opzione per specificare un JSON sotto forma di stringa.
...
1. Trascina e rilascia il passaggio **[!UICONTROL Imposta variabile]** nell&#39;editor del flusso di lavoro, seleziona il passaggio e seleziona ![configure_icon](assets/Smock_Wrench_18_N.svg) (Configura).
...
1. Mappa più variabili per creare un’espressione significativa. Seleziona ![icona_completato](assets/Smock_Checkmark_18_N.svg) per salvare le modifiche.
...
Per ulteriori informazioni, vedere [Editor regole di Forms adattivo](rule-editor.md).
...
Il passaggio Vai a, il passaggio di suddivisione OR e tutti i [!DNL AEM Forms] passaggi del flusso di lavoro supportano le variabili.
...
Tutti i [!DNL AEM Forms] passaggi del flusso di lavoro supportano le variabili. Per ulteriori informazioni, consulta [Flusso di lavoro incentrato su Forms in OSGi](aem-forms-workflow-step-reference.md).
...
| Modello dati modulo (FDM) | Packages.com.adobe.aem.dermis.api.FormDataModelInstance fdmObject = workItem.getWorkflowData().getMetaDataMap().get(variableName, Packages.com.adobe.aem.dermis.api.FormDataModelInstance.class); |
...
1. Seleziona l&#39;icona ![modifica](assets/edit.svg) (Modifica) accanto al nome della variabile da modificare.
1. Modifica le informazioni sulla variabile e seleziona ![done_icon](assets/Smock_Checkmark_18_N.svg) per salvare le modifiche. Impossibile modificare i campi **[!UICONTROL Nome]** e **[!UICONTROL Tipo]** per una variabile.
