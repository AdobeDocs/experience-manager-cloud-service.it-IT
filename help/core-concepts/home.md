---
title: Concetti di base su Adobe Experience Manager come Cloud Service
description: Risorse di supporto autonomo e collegamenti alla documentazione sui concetti di base su Adobe Experience Manager come Cloud Service
translation-type: ht
...
# Concetti di base su Experience Manager come Cloud Service {#aem-core-concepts-guide}

In questa pagina sono elencate le risorse di supporto autonomo relative all’introduzione dei concetti di base su Experience Manager come Cloud Service.

## Articoli principali sui concetti di base {#key-articles}

* [Architettura di AEM come Cloud Service](architecture.md)
