---
title: Connettori di Adobe Experience Manager come Cloud Service
description: Risorse di supporto autonomo e collegamenti alla documentazione sui connettori di Adobe Experience Manager come Cloud Service
translation-type: ht
...
# Implementazione di connettori per Experience Manager come Cloud Service {#aem-connectors-guide}

In questa pagina sono elencate le risorse di supporto autonomo relative ai connettori per Experience Manager come Cloud Service.

## Articoli principali sui connettori di Experience Manager come Cloud Service {#key-articles}

* [Implementazione dei connettori](implement.md)
* [Invio dei connettori](submit.md)
* [Manutenzione dei connettori](maintain.md)
...
| [Panoramica](/help/overview/home.md) | Questa guida offre una panoramica generale di Experience Manager come Cloud Service, con un’introduzione, terminologia e altro ancora. |
