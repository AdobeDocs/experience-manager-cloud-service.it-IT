...
+ Forms {#forms}
   ...
   + Integrare un modulo con una o più origini dati {#use-form-data-model}
      ...
      + [Configura [!DNL Microsoft Dynamics 365] and [!DNL Salesforce] servizi cloud](/help/forms/configure-msdynamics-salesforce.md)
...
+ Implementazione {#implementing}
   ...
   + Configurazione ed estensione di AEM as a Cloud Service {#configuring-and-extending}
      + [Estensione AEM utilizzando Adobe Developer App Builder](/help/implementing/developing/extending/app-builder.md)
