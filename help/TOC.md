...
+ Percorso di migrazione ad AEM as a Cloud Service {#migration-journey}
   ...
   + Note sulla versione per gli strumenti di migrazione {#release-notes-migration-tools}
      + [Note sulla versione corrente (2022.4.0)](/help/journey-migration/release-notes/release-notes-migration-tools-current.md)
...
+ Assets {#assets}
   ...
   + Dynamic Media {#dynamicmedia}
      + percorso Dynamic Media {#dm-journey}
         + [Nozioni di base, parte I](/help/assets/dynamic-media/dm-journey-part1.md)
         + [Base, parte II](/help/assets/dynamic-media/dm-journey-part2.md)
