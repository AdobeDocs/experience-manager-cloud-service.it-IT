...
| `cacheNames` | Questi valori sono definiti nella configurazione client CIF GraphQL corrispondente factory >> Configurazione GraphQL StorePath corrispondente >> Configurazioni cache GraphQL | Array | No | |
