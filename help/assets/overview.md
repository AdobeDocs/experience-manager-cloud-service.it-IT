...
Per iniziare, scopri i vantaggi di un’offerta nativa per il cloud](#solution-benefits). [ Consulta le notevoli [modifiche apportate all’Experience Manager come a [!DNL Cloud Service]](/help/release-notes/aem-cloud-changes.md) che influiscono anche sulle risorse di Experience Manager e seguono le notevoli [modifiche apportate alle risorse](/help/assets/assets-cloud-changes.md).
