...
>[!CAUTION]
>
>In alcune versioni si verifica attualmente un problema noto con l’endpoint:
>
>* A seconda del rilascio utilizzato, la voce `cq:graphql` è visibile nella console **Siti**; al livello superiore.
