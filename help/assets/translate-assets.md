...
description: Scopri come automatizzare i flussi di lavoro per tradurre le risorse in AEM, inclusi binari, metadati e tag in più lingue.
contentOwner: AG
...
Per risorse multilingue si intendono le risorse con file binari, metadati e tag in più lingue. In genere, i binari, i metadati e i tag delle risorse esistono in una lingua, che vengono poi tradotti in altre lingue per l’utilizzo in progetti multilingue. Risorse Adobe Experience Manager consente di automatizzare i flussi di lavoro per tradurre le risorse (inclusi binari, metadati e tag) per generare risorse in altre lingue da utilizzare in progetti multilingue.

Per automatizzare AEM traduzione delle risorse, è possibile integrare fornitori di servizi di traduzione con Experience Manager e creare progetti per la traduzione delle risorse in più lingue. Experience Manager supporta flussi di lavoro di traduzione umana e automatica.

Traduzione di risorse umane in AEM: Le risorse tradotte vengono restituite e importate in Experience Manager. Quando il provider di traduzione è integrato con Experience Manager, le risorse vengono inviate automaticamente tra Experience Manager e il provider di traduzione.

Traduzione automatica delle risorse in AEM: Il servizio di traduzione automatica traduce immediatamente i metadati e i tag delle risorse.
...
Esegui i seguenti passaggi per preparare la traduzione delle risorse:
...
1. Per visualizzare lo stato del processo di traduzione, fai clic sui puntini di sospensione nella parte inferiore del **[!UICONTROL Processo di traduzione]** piastrelle. <!-- For more details around job statuses, see [Monitoring the Status of a Translation Job](/help/sites-administering/tc-manage.md#monitoring-the-status-of-a-translation-job). -->
...
1. Per avviare la traduzione delle risorse, tocca o fai clic sulla freccia **[!UICONTROL Processo di traduzione]** piastrelle e seleziona **[!UICONTROL Inizio]** dall&#39;elenco. Un messaggio notifica l’inizio del processo di traduzione.
1. Per visualizzare lo stato del processo di traduzione, tocca o fai clic sui puntini di sospensione nella parte inferiore del **[!UICONTROL Processo di traduzione]** piastrelle. <!-- For more details, see [Monitoring the Status of a Translation Job](/help/sites-administering/tc-manage.md#monitoring-the-status-of-a-translation-job). -->
...
1. Vedi i passaggi 9-14 di [Aggiungi al progetto di traduzione esistente](#add-to-existing-translation-project) completare il resto della procedura.
