...
Risorse multilingue significa risorse con binari, metadati e tag in più lingue. In genere, i file binari, i metadati e i tag per le risorse esistono in una lingua e vengono quindi tradotti in altre lingue per l’utilizzo in progetti multilingue. Adobe Experience Manager Assets consente di automatizzare i flussi di lavoro di traduzione delle risorse (inclusi file binari, metadati e tag) per generare risorse in altre lingue da utilizzare nei progetti multilingue.

Per automatizzare i flussi di lavoro di traduzione, puoi integrare fornitori di servizi di traduzione con Experience Manager e creare progetti per la traduzione delle risorse in più lingue. Experience Manager supporta flussi di lavoro di traduzione umana e automatica.
...
1. Tocca o fai clic su **[!UICONTROL Crea]**. La directory principale della lingua viene creata nella console Assets.
...
1. Nel riquadro Riferimenti, tocca o fai clic su **[!UICONTROL Copie per lingua]**. Il pannello Copie per lingua mostra le copie per lingua delle risorse.
...
1. Tocca o fai clic su **[!UICONTROL Aggiorna copie per lingua]** in basso.
...
1. Dall’interfaccia utente Assets, seleziona una risorsa già tradotta e tocca o fai clic sul pulsante **[!UICONTROL Modifica]** dalla barra degli strumenti per aprire la risorsa in modalità di modifica.
...
1. Tocca o fai clic sui puntini di sospensione nella parte inferiore della sezione **[!UICONTROL Lavoro di traduzione]** affiancare. Dall’elenco delle risorse in **[!UICONTROL Lavoro di traduzione]** , puoi visualizzare chiaramente la posizione temporanea in cui è memorizzata la versione tradotta della risorsa.
...
1. Dalla barra degli strumenti, tocca o fai clic su **[!UICONTROL Accetta traduzione]**, quindi tocca o fai clic su **[!UICONTROL Accetta]** nella finestra di dialogo, così da sovrascrivere la risorsa tradotta nella cartella di destinazione con la versione tradotta della risorsa modificata.
   ...
   Tocca o fai clic su **[!UICONTROL Rifiuta traduzione]** per mantenere la versione tradotta originariamente della risorsa nella directory principale delle impostazioni locali di destinazione e rifiutare la versione modificata.
...
1. Tocca o fai clic sulla struttura dall’elenco, quindi tocca o fai clic su **[!UICONTROL Mostra in Assets]** per passare alla struttura di cartelle nella lingua di destinazione.
...
1. Tocca o fai clic sul pulsante **[!UICONTROL Configura ora]** collegamento per aprire **[!UICONTROL Crea configurazione]** .
