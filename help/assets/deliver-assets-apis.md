...
Tutti [risorse approvate](approved-assets.md) disponibili in Experience Manager assets repository possono essere [ricercato](search-assets-api.md) e quindi consegnati ad applicazioni a valle integrate utilizzando un URL di consegna.
