...
Gli utenti che dispongono dei diritti per accedere ad Adobe Express e AEM Assets Content Hub e che dispongono dei diritti per eseguire il remix delle risorse in nuove varianti possono modificare le immagini utilizzando Content Hub.

### Come si modifica un’immagine utilizzando Adobe Express in AEM Assets Content Hub?

Per modificare un&#39;immagine, fai clic su **Apri in Adobe Express** sulla scheda delle risorse dell&#39;immagine oppure apri i dettagli dell&#39;immagine e fai clic sul logo Adobe Express. In questo modo viene caricato l’editor di Adobe Express incorporato in AEM Assets Content Hub, che consente di apportare le modifiche senza uscire dalla piattaforma.

### Quali funzioni di modifica sono fornite da Adobe Express in AEM Assets Content Hub?

Adobe Express offre diverse funzioni di modifica delle immagini, tra cui ridimensionamento delle immagini, rimozione o modifica del colore di sfondo, ritaglio delle immagini e combinazione con immagini o testo generati dall’intelligenza artificiale.

### Quali formati di file è possibile salvare le immagini modificate come in AEM Assets Content Hub?

È possibile salvare le immagini modificate in formato PNG (buona qualità), JPG (adatto a file di piccole dimensioni) o PDF (adatto a documenti).

### Quali campi compilare quando si salva un’immagine modificata in Content Hub?

Quando salvi un&#39;immagine modificata, devi specificare un nome per la risorsa nel campo **Salva con nome** e un nome della campagna nel campo **Nome campagna**. Adobe consiglia inoltre di specificare valori in campi aggiuntivi, come Parole chiave, Canali, Intervallo temporale e Area geografica, per migliorare la ricercabilità e l’organizzazione.

### Posso salvare le modifiche come nuova risorsa in Content Hub?

Sì, dopo la modifica, puoi fare clic su **Salva come nuova risorsa** per salvare le modifiche come nuova risorsa in Content Hub.
