...
1. Fare clic su **[!UICONTROL Attiva]** nella finestra di dialogo di conferma per avviare il processo di attivazione di [!DNL Dynamic Media with OpenAPI]. Dopo l’attivazione corretta, Cloud Manager visualizza i seguenti aggiornamenti di stato:
   ...
   1. ![DM attivato](/help/assets/assets/Images_icon.svg)**[!UICONTROL Dynamic Media ]**:**[!UICONTROL  Le funzionalità OpenAPI sono attivate ]**      ![attivazione completata](/help/assets/assets/activation-successful.png){width="700" align="left"}
...
* ![DM attivato](/help/assets/assets/Images_icon.svg)**[!UICONTROL Dynamic Media ]**:**[!UICONTROL  Impossibile attivare le funzionalità OpenAPI ]**  ![riprova attivazione](/help/assets/assets/retry-dm-openapi-failed-activation.png){width="700" align="left"}
