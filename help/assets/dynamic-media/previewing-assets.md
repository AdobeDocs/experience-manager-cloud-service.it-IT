...
Per attivare o disattivare i predefiniti per visualizzatori nell’interfaccia utente, consultate [Gestione dei predefiniti](/help/assets/dynamic-media/managing-viewer-presets.md)per visualizzatori.
