...
1. A seconda del tipo di risorsa su cui hai fatto clic, effettua una delle seguenti operazioni:
   ...
   <table>
    <tbody>
      ...
      <li>Per ripristinare l'immagine nella mappa di zoom originale, tocca <strong>Ripristina</strong>.</li>
      <li>Per massimizzare il visualizzatore sul dispositivo di visualizzazione, tocca <strong>Schermo intero</strong>.</li>
      </ul>
