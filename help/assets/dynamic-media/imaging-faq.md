...
Vedi anche [Ottimizzazione delle immagini con formati immagine di nuova generazione (WebP e AVIF)](https://medium.com/adobetech/image-optimisation-with-next-gen-image-formats-webp-and-avif-248c75afacc4)
...
Abilitando l&#39;ottimizzazione del rapporto pixel del dispositivo, l&#39;immagine viene riprodotta alla risoluzione nativa dello schermo, rendendo l&#39;immagine più nitida.
...
Supponiamo ad esempio che un predefinito immagine sia definito con formato JPEG, dimensioni 500 x 500, qualità=85 e maschera di contrasto=0.1,1,5. Quando Smart Imaging rileva che un utente si trova su un browser Chrome, l’immagine viene convertita in formato WebP, con dimensioni 500 x 500, e unsharp mask=0.1,1,5 con una qualità WebP che corrisponde a una qualità JPEG di 85 il più simile possibile. L’ingombro di tale conversione WebP viene confrontato con il JPEG e viene restituito il più piccolo dei due.
