...
Consulta anche [Incorporare il visualizzatore di video o immagini in una pagina web](embed-code.md).
...
Consulta anche [Caricare risorse](/help/assets/manage-digital-assets.md#uploading-assets).
