...
Consultate anche [Incorporamento del visualizzatore video o di immagini in una pagina Web](embed-code.md).

Consultate anche [Collegamento di URL di YouTube all&#39;applicazione Web](video.md).

Vedere anche [Distribuzione di immagini ottimizzate per un sito reattivo](responsive-site.md).

Vedere anche [Caricamento delle risorse](/help/assets/manage-digital-assets.md#uploading-assets).
...
1. In base alla risorsa selezionata, effettuate una delle seguenti operazioni:
   ...
   * Se hai selezionato un&#39;immagine, tocca **[!UICONTROL Rappresentazioni]** nel menu a discesa.
   ...
   * Se avete selezionato un set 360 gradi, un set di immagini, un set carosello o un video, toccate **[!UICONTROL Visualizzatori]** nel menu a discesa.
...
1. Nella pagina **[!UICONTROL Dynamic Media Cloud Settings]**, in **[!UICONTROL URL del servizio video]**, copiate l&#39;intero percorso dell&#39;URL. Sarà necessario che il percorso dell’URL copiato venga completato più avanti nei passaggi descritti.
...
1. Vicino all&#39;angolo superiore sinistro della pagina, toccare **[!UICONTROL Cloud Services]**, quindi toccare l&#39;icona AEM e passare a **[!UICONTROL Generale > CRXDE Lite]**.
...
1. Nella pagina **[!UICONTROL Cloud Services]**, scorri verso il basso fino all’intestazione **[!UICONTROL Servizi cloud per elementi multimediali dinamici]**, quindi tocca **[!UICONTROL Mostra configurazioni]**.
1. In **[!UICONTROL Configurazioni disponibili]**, tocca il nome della configurazione desiderata.
1. Nella pagina **[!UICONTROL Impostazioni Cloud Services Dynamic Media]**, effettuare le seguenti operazioni:
...
1. In base al protocollo di distribuzione video in uso, copiate il rispettivo selettore di protocollo. Sarà necessario il selettore di protocollo copiato più avanti in questi passaggi.
   ...
   <table>
    <tbody>
      ...
      <tr>
      <td><p>HTTP</p> <p>Se utilizzate HTTP (distribuzione di video non sicura), accertatevi di cambiare <code>https</code> in <code>http</code> nel valore URL del servizio video copiato in precedenza.</p> </td>
