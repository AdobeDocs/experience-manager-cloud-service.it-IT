...
Come indicato nei casi di [utilizzo per l’integrazione](#use-cases-for-the-integration), è possibile monitorare i visualizzatori Dynamic Media con la nuova integrazione di Adobe Launch in AEM Sites e utilizzando il codice da incorporare.
...
Consultate [Aggiunta di risorse Dynamic Media alle pagine tramite Adobe Sites](/help/assets/dynamic-media/adding-dynamic-media-assets-to-pages.md).
...
* Il nodo di creazione AEM è configurato in Dynamic Media. <!-- Scene7 run mode (dynamicmedia_s7) -->
