...
Consultate [Aggiunta di risorse multimediali dinamiche alle pagine tramite  Siti](/help/assets/dynamic-media/adding-dynamic-media-assets-to-pages.md)Adobe.
...
Consultate [Incorporamento di video o visualizzatori di immagini in una pagina](/help/assets/dynamic-media/embed-code.md) Web per ulteriori informazioni sull’utilizzo della funzione di codice da incorporare AEM file multimediali dinamici.
...
* (Obbligatorio) *estensione del servizio* ID Experience Cloud
...
1. In una nuova scheda del browser, andate alla [console](https://console.adobe.io/integrations)Adobe I/O.
...
1. Nella pagina **[!UICONTROL Generale]** (1/3 pagine) della finestra **[!UICONTROL Crea configurazione di Adobe Launch]**, compila i campi seguenti:
   ...
   * **[!UICONTROL Società]** - Dall&#39;elenco a discesa **[!UICONTROL Società]** , selezionate la società del Experience Cloud . L&#39;elenco viene compilato automaticamente.
...
Consulta [Integrare AEM con  Adobe Launch tramite  Adobe I/O](https://helpx.adobe.com/experience-manager/using/aem_launch_adobeio_integration.html) per ulteriori informazioni sulla configurazione  Adobe di Launch Cloud Configuration.