...
Questa integrazione consente di monitorare l’utilizzo dei visualizzatori Dynamic Media sul sito web con Adobe Analytics. Allo stesso tempo, puoi utilizzare gli eventi e i dati esposti dai visualizzatori con qualsiasi altra estensione di Platform launch proveniente da un Adobe o da una terza parte.

Per ulteriori informazioni sulle estensioni, consulta [Estensioni di Adobe](https://experienceleague.adobe.com/docs/launch/using/extensions-ref/overview.html#adobe-extension) nella Guida utente di Experience Platform Launch.
...
Consulta [Elementi dati](https://experienceleague.adobe.com/docs/launch/using/ui/data-elements.html#ui) nella Guida utente del Experience Platform Launch.
...
Consulta [Rules](https://experienceleague.adobe.com/docs/launch/using/ui/rules.html#ui) nella Guida utente del Experience Platform Launch.
...
1. Nella pagina **[!UICONTROL Configurazioni Experience Platform Launch]**, seleziona un sito di Experience Manager per il quale desideri applicare la configurazione del Experience Platform Launch nel pannello a sinistra.
   ...
   Solo a scopo di spiegazione, il sito **[!UICONTROL We.Retail]** è selezionato nella schermata seguente.
...
1. Nella pagina **[!UICONTROL Staging]** (2/3 pagine) della finestra **[!UICONTROL Crea configurazione Experience Platform Launch]**, compila il seguente campo:
   ...
   Solo a scopo di spiegazione, questo passaggio utilizza librerie di Experience Platform Launch distribuite su CDN di Adobe.
...
È tuttavia supportato nel nodo di pubblicazione Experience Manager. Utilizzando le impostazioni predefinite di Configurazione cloud di Experience Platform Launch, la pubblicazione in Experience Manager utilizza l’ambiente di produzione di Experience Platform Launch. Di conseguenza, è necessario inviare ogni volta durante il test gli aggiornamenti della libreria di Experience Platform Launch da Sviluppo all’ambiente di produzione.

È possibile aggirare questa limitazione. Specifica l&#39;URL di sviluppo o staging della libreria di Experienci Platform Launch nella configurazione di Experience Platform Launch Cloud per l&#39;Experience Manager di pubblicazione precedente. In questo modo il nodo di pubblicazione Experience Manager utilizza la versione di sviluppo o staging della libreria di Experience Platform Launch.

Per ulteriori informazioni sulla configurazione della configurazione di Experience Platform Launch Cloud Configuration, consulta [Integrate Experience Platform Launch and Experience Manager](https://experienceleague.adobe.com/docs/experience-manager-learn/sites/integrations/experience-platform-launch/overview.html#integrations) .
