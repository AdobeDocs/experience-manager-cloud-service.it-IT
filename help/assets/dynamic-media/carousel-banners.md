...
>[!NOTE]
>
>Gli utenti non amministrativi devono essere aggiunti al gruppo **[!UICONTROL dam-users]** per poter creare o modificare i banner del carosello. In caso di problemi durante la creazione o la modifica, rivolgiti all&#39;amministratore di sistema, che può aggiungere gli utenti al gruppo **d[!UICONTROL am-users]**.
...
1. Effettua una delle operazioni seguenti:
   ...
   * [Aggiungete un banner carosello al sito Web in ](/help/assets/dynamic-media/adding-dynamic-media-assets-to-pages.md)AEMIse siete un cliente AEM Sites  potete aggiungere il set carosello direttamente alla pagina in AEM, utilizzando il componente Supporto interattivo.
