...
Dynamic Media include un componente Dynamic Media 3D Media che è possibile utilizzare in [!DNL Experience Manager Sites] per consentire la visualizzazione interattiva di modelli 3D nelle pagine Web.
