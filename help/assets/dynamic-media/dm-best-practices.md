...
L’assegnazione tag alle risorse migliora la ricercabilità, la creazione di raccolte e la classificazione delle ricerche. Adobe AI utilizza un algoritmo di apprendimento automatico per assegnare tag precisi che consentono di recuperare rapidamente le risorse. Adobe AI riconosce e assegna inoltre tag rilevanti alle risorse, inclusi quelli personalizzati, semplificando la gestione delle risorse con l’assegnazione automatica di tag descrittivi.
