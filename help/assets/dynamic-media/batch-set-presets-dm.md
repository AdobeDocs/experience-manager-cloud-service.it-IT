...
>[!IMPORTANT]
>
>Stai utilizzando i predefiniti per set di batch in [!DNL Dynamic Media Classic] e stai eseguendo la migrazione da [!DNL Dynamic Media Classic] ad Adobe Experience Manager come Cloud Service? In tal caso, è necessario ricreare manualmente le definizioni dei predefiniti per set di batch all&#39;interno di [!DNL Adobe Experience Manager as a Cloud Service].

**Procedure consigliate** : quando si lavora con i predefiniti per set di batch, l’Adobe consiglia il seguente flusso di lavoro:

1. Crea un predefinito per set di batch. Consulta [Creare un set di batch predefinito per un set di immagini o un set 360 gradi](#creating-bsp).
...
1. Nella pagina **[!UICONTROL Predefiniti set di batch]**, vicino all&#39;angolo superiore destro, seleziona **[!UICONTROL Crea]**.
...
1. Crea uno o più gruppi di espressioni regolari.
   ...
   * A sinistra della pagina **[!UICONTROL Modifica predefinito set di batch]**, in **[!UICONTROL Corrispondenza]**, **[!UICONTROL Nome base]** o **[!UICONTROL Ordinamento sequenza]**, selezionare **[!UICONTROL Aggiungi gruppo]**.
...
1. Effettua una delle operazioni seguenti:
   ...
   * Per aggiungere un altro nuovo gruppo, in **[!UICONTROL Match]**, **[!UICONTROL Base Name]** o **[!UICONTROL Sequencing Order]**, selezionare **[!UICONTROL Add Group]**. Crea un altro gruppo di espressioni regolari come nel passaggio precedente.
...
Consulta [Creare un Batch Set Preset per un set di immagini o un set 360 gradi](#creating-bsp) o [Modificare un Batch Set Preset](#edit-bsp).

| **[!UICONTROL Dettagli del predefinito]** | Descrizione |
| --- | --- |
| Nome predefinito | Sola lettura. Nome specificato al momento della creazione del set di batch. Se è necessario rinominare il predefinito, è possibile copiare il Batch Set Preset esistente e specificare un nuovo nome. Consulta [Copiare un Batch Set Preset esistente](#copy-bsp). |
...
1. Nella barra degli strumenti, selezionare **[!UICONTROL Applica predefinito batch alle cartelle]**.
...
1. Nell&#39;angolo in alto a destra della pagina **[!UICONTROL Seleziona cartelle]**, selezionare **[!UICONTROL Applica]**.
...
1. Nella pagina Proprietà della cartella, seleziona la scheda **[!UICONTROL Elaborazione Dynamic Media]** .
...
1. In **[!UICONTROL Predefiniti set di batch]**, dall&#39;elenco a discesa **[!UICONTROL Nome predefinito]**, selezionare il nome di un predefinito set di batch da applicare. La schermata precedente mostra due predefiniti set di batch selezionati applicati alla cartella delle risorse.
   ...
   Se nella casella di riepilogo a discesa **[!UICONTROL Nome predefinito]** non sono presenti nomi predefiniti per set di batch, significa che non è stato ancora creato alcun predefinito per set di batch. Consulta [Creare un set di batch predefinito per un set di immagini o un set 360 gradi](#creating-bsp).
...
Tuttavia, non è possibile modificare il nome o il tipo di predefinito del predefinito (set di immagini o set 360 gradi). Se risulta necessario modificare il nome di un predefinito, copia il predefinito esistente e specifica un nuovo nome. Consulta [Copiare un Batch Set Preset](#copy-bsp).
...
1. Nell&#39;angolo in alto a destra della pagina **[!UICONTROL Preimpostazione set di batch]**, selezionare **[!UICONTROL Salva]**.
...
Se invece desideri *eliminare* i predefiniti dalle cartelle, consulta [Eliminare i predefiniti per set di batch](#delete-bsp).

Esistono due metodi per rimuovere i predefiniti per set di batch dalle cartelle.

* [Rimuovi i predefiniti per set di batch dalle cartelle tramite la pagina](#remove-bsp-from-folders-via-bsp-page)  Batch Set Preset : questo metodo offre la massima flessibilità. È possibile rimuovere uno o più predefiniti da una o più cartelle.
* [Rimuovi i predefiniti per set di batch dalla pagina](#remove-bsp-from-folders-via-properties)  Proprietà di una cartella. Questo metodo consente di rimuovere uno o più predefiniti per set di batch da una sola cartella.
...
1. Nella barra degli strumenti, selezionare **[!UICONTROL Rimuovi predefinito batch da cartelle]**.
...
1. Nell&#39;angolo in alto a destra della pagina **[!UICONTROL Seleziona cartelle]**, selezionare **[!UICONTROL Rimuovi]**.
...
1. In **[!UICONTROL Predefiniti set di batch]**, seleziona **[!UICONTROL X]** a destra del tipo di predefinito.
...
Se invece desideri *rimuovere* i predefiniti dalle cartelle, consulta [Rimuovere i predefiniti per set di batch dalle cartelle](#remove-bsp-from-folder).
...
1. Nella finestra di dialogo **[!UICONTROL Elimina predefiniti set di batch]**, selezionare **[!UICONTROL Elimina]**.

   Se una cartella di risorse contiene un riferimento al predefinito che stai eliminando, seleziona **[!UICONTROL Forza eliminazione]**.
...
* [Crea una configurazione Dynamic Media in Cloud Services](/help/assets/dynamic-media/config-dm.md#configuring-dynamic-media-cloud-services) . Per ulteriori informazioni sulla sincronizzazione di tutte le cartelle in  [!DNL Dynamic Media], consulta &quot;Modalità di sincronizzazione Dynamic Media&quot; nell’argomento.
