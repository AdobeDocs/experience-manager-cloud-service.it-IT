...
1. Nella finestra di dialogo **[!UICONTROL Crea predefinito per set di batch]**, nel campo di testo **[!UICONTROL Nome predefinito]** immettete un nome descrittivo. Tenete presente che il nome del predefinito non può essere modificato se successivamente decidete di modificarlo.
...
1. Sul lato destro della pagina **[!UICONTROL Modifica predefinito set di batch]**, impostate le opzioni modificabili desiderate nelle intestazioni **[!UICONTROL Dettagli predefinito]** e **[!UICONTROL Imposta convenzione di denominazione]**.
...
1. Create uno o più gruppi di espressioni regolari.
   ...
   * Sul lato sinistro della pagina **[!UICONTROL Modifica predefinito set di batch]**, in **[!UICONTROL Corrispondenza]**, **[!UICONTROL Nome base]** o **[!UICONTROL Ordine sequenza]**, toccare **[!UICONTROL Aggiungi gruppo]**.
   * Il campo **[!UICONTROL Match]** è obbligatorio. **[!UICONTROL Il]** nome di base è obbligatorio solo se il  **** campo corrispondente non specifica già un nome di base tramite un raggruppamento di parentesi. **[!UICONTROL L&#39;]** ordine delle sequenze è facoltativo.
...
1. Effettua una delle operazioni seguenti:
   ...
   * Controllare la sintassi delle espressioni regolari nell&#39;area **[!UICONTROL Risultati regola - RegX]**. Se è necessario apportare modifiche alla sintassi, apportare le modifiche nel rispettivo gruppo sul lato sinistro della pagina.
...
Le cartelle a cui è stato assegnato un predefinito per batch sono indicate nell&#39;interfaccia utente in base al nome del predefinito visualizzato nella cartella, nella vista **[!UICONTROL Scheda]**.
...
Come procedura ottimale, assicuratevi che le cartelle di risorse siano sincronizzate [!DNL Dynamic Media], quindi applicate i predefiniti desiderati.
...
1. Sulla barra degli strumenti, toccate **[!UICONTROL Applica predefinito per batch alle cartelle]**.
...
1. Nell&#39;angolo superiore destro della pagina **[!UICONTROL Seleziona cartella(e)]**, toccare **[!UICONTROL Applica]**.
...
1. In **[!UICONTROL Predefiniti per set di batch]**, nella casella di riepilogo a discesa **[!UICONTROL Nome predefinito]**, selezionate il nome di un predefinito per set di batch da applicare. La schermata precedente mostra due predefiniti per set di batch applicati alla cartella.
...
Per applicare nuovamente il predefinito appena modificato alle risorse esistenti nella cartella, dovete rielaborare la cartella. <!-- See [Reprocessing assets in a folder](/help/assets/dynamic-media/about-image-video-profiles.md#reprocessing-assets). --> In questo modo, le risorse esistenti ora si qualificano come parte di un set di immagini o set 360 gradi e vengono aggiunte. Inoltre, le risorse già incluse nel set di immagini o set 360 gradi, in base al precedente predefinito per set di batch utilizzato, non vengono rimosse (purché non si qualifichino più in base al nuovo predefinito modificato) e verranno visualizzate così com’è.
...
1. Sulla barra degli strumenti, toccare **[!UICONTROL Modifica predefinito set di batch.]**
...
1. Sulla barra degli strumenti, toccate **[!UICONTROL Rimuovi predefinito per batch dalle cartelle]**.

1. Nella pagina **[!UICONTROL Seleziona cartelle]**, selezionate una o più cartelle in cui desiderate rimuovere i predefiniti per set di batch. La schermata precedente mostra una cartella selezionata con i nomi di due predefiniti per set di batch già applicati e che verranno rimossi.
1. Nell&#39;angolo superiore destro della pagina **[!UICONTROL Seleziona cartella(e)]**, toccare **[!UICONTROL Rimuovi]**.
...
1. In **[!UICONTROL Predefiniti set di batch]**, toccate **[!UICONTROL X]** a destra del tipo di predefinito.
...
Se desiderate semplicemente *rimuovere i predefiniti* dalle cartelle, consultate [Rimozione dei predefiniti per set di batch dalle cartelle](#remove-bsp-from-folder).
...
1. Sulla barra degli strumenti, toccare **[!UICONTROL Elimina predefinito/i set di batch]**.
...
1. Nella finestra di dialogo **[!UICONTROL Elimina predefiniti per set di batch]**, toccare **[!UICONTROL Elimina]**.
   ...
   Se una cartella di risorse fa riferimento al predefinito che state eliminando, potrebbe essere necessario toccare **[!UICONTROL Forza eliminazione]**.
