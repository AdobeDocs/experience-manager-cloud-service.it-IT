...
description: Scopri le best practice che consentono di ottimizzare la qualità delle risorse di immagini utilizzando Dynamic Media.
...
* JPG si comprime con un rapporto di 10:1 e di solito produce file di dimensioni inferiori. PNG si comprime a un rapporto di circa 2:1, tranne quando le immagini contengono uno sfondo bianco. In genere, tuttavia, le dimensioni dei file PNG sono maggiori dei file JPG.
...
* Libro bianco sulle migliori pratiche [Tecniche consigliate per la qualità delle immagini e la nitidezza di Adobe Dynamic Media Classic](/help/assets/dynamic-media/assets/sharpening_images.pdf) si applica anche all&#39;Experience Manager.

* Guarda [Utilizzare la nitidezza delle immagini con Experience Manager - Dynamic Media](https://experienceleague.adobe.com/docs/experience-manager-learn/assets/dynamic-media/dynamic-media-image-sharpening-feature-video-use.html#dynamic-media).
...
Il parametro `jpegSize` è utile se desideri garantire che un&#39;immagine non superi una determinata dimensione per la distribuzione su dispositivi con memoria limitata.
