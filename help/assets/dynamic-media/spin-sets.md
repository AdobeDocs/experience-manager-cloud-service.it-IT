...
1. Configurazione [Predefiniti visualizzatore set 360 gradi](/help/assets/dynamic-media/managing-viewer-presets.md), in base alle esigenze.
...
Se necessario, puoi [modifica set 360 gradi](#editing-spin-sets). Inoltre, puoi visualizzare e modificare [Proprietà set 360 gradi](/help/assets/manage-digital-assets.md#editing-properties).
...
1. All’apertura delle proprietà di una singola risorsa. Le proprietà indicano di quali set la risorsa selezionata è membro (in **[!UICONTROL Membro di set]**). Per visualizzare l&#39;intero set, selezionate il nome del set.
...
1. Effettua una delle seguenti operazioni:
   ...
   * Seleziona una risorsa Set 360 gradi, quindi fai clic su **[!UICONTROL Modifica]** (icona della matita) sulla barra degli strumenti.
