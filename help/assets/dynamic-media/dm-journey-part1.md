...
**_Pubblico_**
I tipi di pubblico più adatti ai lettori di questo percorso sono i seguenti, che non hanno mai utilizzato Dynamic Media su Experience Manager:
...
Dynamic Media ti consente di offrire risorse visive avanzate di marketing e merchandising su richiesta. Consente inoltre di creare e distribuire esperienze di visualizzazione interattive, tra cui zoom, 360 gradi in rotazione e video. Le risorse vengono scalate in modo dinamico per l’utilizzo su siti web, mobili e social network. Utilizzando una serie di risorse di origine principali, come immagini, video e 3D, Dynamic Media genera e distribuisce in tempo reale più varianti di questi rich content attraverso la rete CDN (Content Delivery Network) globale, scalabile e ottimizzata per le prestazioni.

Dynamic Media incorpora i flussi di lavoro della soluzione di gestione delle risorse digitali Adobe Experience Manager Assets per semplificare e semplificare il processo di gestione delle campagne digitali.

### Un file con infinite possibilità

Uno dei punti principali da capire su Dynamic Media è il concetto di _Un file di risorsa principale con infinite possibilità_.
...
Dynamic Media è già in grado di ottimizzare le risorse e garantire che ogni risorsa venga caricata rapidamente sui sistemi mobili e desktop tramite la rete CDN. Per realizzare questo obiettivo, in Dynamic Media vengono utilizzati predefiniti per immagini per definire la qualità dell&#39;immagine. Inoltre, definiscono il tipo di immagine che stai inviando, la sua nitidezza e altri elementi per varie parti delle esperienze o delle pagine.

Tuttavia, per aggiungere ancora più valore a Dynamic Media oltre ai predefiniti per immagini, esiste _Imaging avanzato_.
...
L’imaging avanzato non è attivato per impostazione predefinita perché richiede uno sforzo coordinato tra l’utente e il supporto tecnico Adobe Dynamic Media. Inoltre, l’abilitazione di Smart Imaging richiede la cancellazione completa della cache CDN, che viene quindi riempita con il tempo. Se sei interessato a utilizzare Smart Imaging, puoi lavorare con Adobe per attivarlo inviando un ticket di supporto tecnico. Il supporto tecnico fornisce quindi un parametro URL che consente di provare, in anticipo, l’imaging intelligente. Puoi provarlo su qualsiasi pagina web o immagine in modo da vedere le prestazioni che ottieni e i risparmi. È quindi possibile attivare la tecnologia Smart Imaging per l&#39;intero sito.
...
Inizia con il tuo video originale principale, che carichi nel sistema. Dynamic Media ridimensiona automaticamente o _transcodifica_, quel video in più video. Quindi, al momento della consegna, determina in modo intelligente quale schermo video, quale qualità e quale formato utilizzare e lo distribuisce al telefono, al tablet o al computer desktop.
...
Di seguito sono riportati i problemi comuni relativi ai casi d’uso e le soluzioni che Dynamic Media può aiutarti a gestire per favorire il coinvolgimento, la fedeltà, la conversione e l’aumento del ROI dei clienti.

### Caso d’uso: approccio basato su file primario

Uno dei casi d’uso più importanti per Dynamic Media è anche uno dei più ovvi. In altre parole, riducendo il peso delle pagine e delle esperienze e le dimensioni del contenuto, che si tratti di un’immagine o di un video, che viene distribuito.
...
Esaminiamo più da vicino i problemi che Dynamic Media sta risolvendo con un file e alcune delle soluzioni a questo approccio.
...
| I video si interrompono o vengono riprodotti in bassa qualità a causa della larghezza di banda disponibile dell&#39;utente finale. | Distribuisci il video attraverso un lettore HTML che rileva automaticamente la larghezza di banda disponibile e adatta la qualità per garantire un&#39;alta fedeltà e una riproduzione fluida. |
...
| Risorse monouso create per ogni esperienza e dispositivo. | Elimina attività manuali noiose e offre immagini e video di alta qualità con caricamento rapido che si presentano correttamente su qualsiasi dispositivo o schermo. |
...
![Flusso di lavoro di Dynamic Media](/help/assets/dynamic-media/assets/dm-workflow.png)
...
Al termine della creazione, la risorsa viene inserita nella soluzione di authoring caricandola in Dynamic Media. In Dynamic Media, assicurati di disporre dei predefiniti immagine e dei visualizzatori giusti allineati per le varie pagine web del sito.

Infine, ottimizzate tutti i contenuti e li pubblicate sui server Dynamic Media in modo che siano disponibili per il web, la stampa, la posta elettronica, i desktop e i dispositivi mobili.

### Caricamento di risorse in Dynamic Media

Al termine della creazione, la risorsa principale viene caricata in Dynamic Media. Il tipo di file caricato, il formato e le dimensioni del file sono attributi importanti per Dynamic Media. È al momento del caricamento che desideri assicurarti di ottenere il valore massimo dal supporto di un file.

Ad esempio, l&#39;immagine dell&#39;orologio qui sotto è di 4560 x 3020 pixel. E anche se non si può mai usare un&#39;immagine di quelle dimensioni, è comunque possibile caricarla. Più grande è l&#39;immagine, migliore è la qualità offerta da Dynamic Media, fino alla rappresentazione in miniatura. Ricorda: puoi facilmente _diminuzione_ risoluzione di un&#39;immagine esistente. Ma se provi a _aumentare_ risoluzione di un&#39;immagine, il risultato sarà probabilmente insoddisfacente.
...
La maggior parte non penserebbe mai a consegnare qualcosa in CMYK o perché si potrebbe anche volere consegnare in CMYK. Il motivo è che lo spazio colore viene utilizzato più spesso per la consegna di articoli stampati. Ma Dynamic Media è in grado di fornire in entrambi gli spazi di colore.
...
* [Come distribuire risorse Dynamic Media](/help/assets/dynamic-media/delivering-dynamic-media-assets.md)
