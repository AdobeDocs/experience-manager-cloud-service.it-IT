...
>[!NOTE]
>
>Per generare i metadati di un video e le miniature delle immagini video associate, il video stesso deve seguire il processo di codifica in Contenuti multimediali dinamici. In AEM, il flusso di lavoro Codifica video **[!UICONTROL per contenuti multimediali]** dinamici codifica i video se avete attivato i contenuti multimediali dinamici e impostato i servizi cloud per video. Questo flusso di lavoro acquisisce la cronologia del processo del flusso di lavoro e le informazioni di errore. Consultate [Monitoraggio della codifica video e Stato](/help/assets/dynamic-media/video.md#monitoring-video-encoding-and-youtube-publishing-progress)della pubblicazione su YouTube. Se avete attivato i contenuti multimediali dinamici e impostato i servizi cloud per video, il flusso di lavoro di codifica video **[!UICONTROL per file multimediali]** dinamici ha effetto automaticamente al momento del caricamento di un video. (Se non utilizzate contenuti multimediali dinamici, ha effetto il flusso di lavoro Aggiorna risorsa **** DAM.)
>
