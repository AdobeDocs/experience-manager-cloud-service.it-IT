...
L’utilizzo di Dynamic Media non è disponibile nell’interfaccia utente classica. Vedi [Utilizzare Dynamic Media,](/help/assets/dynamic-media/dynamic-media.md) che copre l’interfaccia utente touch.
