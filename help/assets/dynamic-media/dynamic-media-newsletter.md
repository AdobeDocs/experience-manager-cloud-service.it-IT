...
description: La newsletter Dynamic Media per Experience League è una newsletter mensile. È stato progettato per aiutarti a imparare a usare Dynamic Media e Dynamic Media Classic in modo da poter realizzare valore immediatamente. In questa newsletter dedicata allo sportello unico sono disponibili preziose risorse per lo sviluppo delle conoscenze. Ad esempio, sono disponibili video dimostrativi e panoramiche delle soluzioni. Scopri alcune delle funzioni e funzionalità chiave come i predefiniti per immagini, i predefiniti per visualizzatori, i profili video e altro ancora.
...
# ![Logo newsletter Dynamic Media](/help/assets/dynamic-media/assets/dynamic-media-newsletter-logo.png)
...
* **[Aprile 2020, numero 3](https://experienceleague.adobe.com/tools/dynamic-media-demo/newsletter/Dynamic_Media_Newsletter_04_2020_April.html)**
   ...
   * Incontro `John Monroe`, Senior Program Manager per il team account Adobe.
...
* **[Febbraio 2020, numero 2](https://experienceleague.adobe.com/tools/dynamic-media-demo/newsletter/Dynamic_Media_Newsletter_02_2020_Feb.html)**
   ...
   * Incontro `Georgia Myers`, Manager del successo del cliente per Adobe Experience Cloud.
