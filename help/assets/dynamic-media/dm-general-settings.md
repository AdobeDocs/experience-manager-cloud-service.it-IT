...
>[!NOTE]
>
>Eseguire l’aggiornamento da Dynamic Media Classic a Dynamic Media su Adobe Experience Manager? La pagina Impostazioni generali e [Impostazione pubblicazione](/help/assets/dynamic-media/dm-publish-settings.md) in Dynamic Media sono precompilati con i valori presi dal tuo account Dynamic Media Classic. Le eccezioni sono tutti i valori elencati in **[!UICONTROL Opzioni di caricamento predefinite]** nella pagina Impostazioni generali. Questi valori sono già in Experience Manager. Di conseguenza, qualsiasi modifica apportata in **[!UICONTROL Opzioni di caricamento predefinite]**, in una qualsiasi delle cinque schede, tramite l’interfaccia utente di Experience Manager, si riflette in Dynamic Media, non in Dynamic Media Classic. Tutte le altre impostazioni e i valori nella pagina Impostazioni generali e nella [Impostazione pubblicazione](/help/assets/dynamic-media/dm-publish-settings.md) tra Dynamic Media Classic e Dynamic Media su Experience Manager.
