...
[supporto](https://helpx.adobe.com/support.html) di Adobe può configurare un filtro di riferimento a livello CDN in modo che il contenuto Dynamic Media venga distribuito solo ai siti Web inclusi nell’elenco dei siti Web consentiti per il dominio.
