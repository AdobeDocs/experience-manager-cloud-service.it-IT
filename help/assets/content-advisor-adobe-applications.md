---
title: Utilizzare Contenuto verificato per accedere ai contenuti di AEM nelle applicazioni Adobe
description: Content Advisor offre un'esperienza di individuazione unificata dei contenuti nelle applicazioni Adobe e porta l'individuazione intelligente e sensibile al contesto direttamente nell'esperienza di authoring.
...
>[!IMPORTANT]
> 
> La pillola per frammenti di contenuto non è attualmente disponibile e sarà presto supportata per le applicazioni Adobe appropriate.
...
* Accesso a un ambiente AEM Sites in cui sono stati creati frammenti di contenuto.
