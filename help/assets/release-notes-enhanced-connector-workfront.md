...
>[!IMPORTANT]
>
>L’Adobe consiglia di: [aggiornamento alla versione più recente del 1.9.10](../assets/update-workfront-enhanced-connector.md) del [!DNL Workfront for Experience Manager enhanced connector].
