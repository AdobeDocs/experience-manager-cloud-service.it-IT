...
La data di rilascio dell’ultima versione 1.9.8 di [!DNL Workfront for Experience Manager enhanced connector] è il 3 marzo 2023.
...
>[!IMPORTANT]
>
>L’Adobe consiglia di: [aggiornamento alla versione 1.9.8 più recente](../assets/update-workfront-enhanced-connector.md) del [!DNL Workfront for Experience Manager enhanced connector].
...
>* [Integrare [!DNL Workfront for Experience Manager enhanced connector] all&#39;Experience Manager 6.4](https://experienceleague.adobe.com/docs/experience-manager-64/assets/integrations/workfront-integrations.html?lang=en)