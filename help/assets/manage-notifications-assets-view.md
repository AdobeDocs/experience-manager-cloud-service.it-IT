...
1. Nella vista Assets viene visualizzato un elenco delle risorse sottoscritte, con nome, tipo e percorso. Seleziona una risorsa, una cartella o una raccolta dall&#39;elenco per visualizzarne i dettagli, la posizione o per [annullare l&#39;iscrizione](#unsubscribe-to-content).
   ...
   ![visualizza contenuto sottoscritto](assets/view-watched-assets.png)
...
1. Fai clic sull&#39;icona dell&#39;occhio![occhio](assets/do-not-localize/eye-icon.png) nel riquadro di destra per visualizzare un elenco degli utenti che controllano il contenuto.

   In alternativa, fare clic sull&#39;icona ![Commento](assets/do-not-localize/comment-icon.svg) nel riquadro di destra per visualizzare i controlli contenuto.
...
1. Seleziona la risorsa, la cartella o la raccolta a cui vuoi annullare l&#39;iscrizione e fai clic su **[!UICONTROL Non osservare più]**.
   ...
   ![annulla sottoscrizione contenuto](assets/unsubscribe-assets.png)
