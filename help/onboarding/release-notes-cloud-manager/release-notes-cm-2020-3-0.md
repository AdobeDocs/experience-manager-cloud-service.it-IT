---
title: Note sulla versione per Cloud Manager in AEM come versione di Cloud Service 2020.3.0
description: Note sulla versione per Cloud Manager in AEM come versione di Cloud Service 2020.3.0
...
# Note sulla versione per Cloud Manager in Adobe Experience Manager come Cloud Service 2020.3.0 {#release-notes}

In questa pagina sono delineate le Note sulla versione di Marketing Cloud Manager in AEM come Cloud Service 2020.3.0.

## Data di rilascio {#release-date}

La data di rilascio per Cloud Manager in AEM come Cloud Service 2020.3.0 è il 5 marzo 2020.
