...
#### Problemi AZCopy {#azcopy-issues}

* `AZCopy critical failure` - In rari casi, lo strumento AZCopy utilizzato per eseguire il passaggio di pre-copia dell’acquisizione può non riuscire in modo imprevisto. In questo caso, devi tentare di nuovo l’acquisizione.
