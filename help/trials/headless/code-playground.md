...
>abstract="Questa guida descrive come eseguire query sui dati JSON dall’ambiente di prova in un’app web JavaScript di base. Useremo i frammenti di contenuto che hai modellato e creato nei moduli di apprendimento precedenti, quindi consulta quelle guide prima di procedere con questa."
...
Configuriamo il client AEM headless alla riga 12:
...
Ora che hai creato modelli e query, il tuo team addetto ai contenuti può procedere con il lavoro. Nel prossimo modulo presenteremo il flusso per la creazione di contenuti.
