...
Nel documento precedente del percorso del componente aggiuntivo Demo di riferimento AEM, [Crea sito demo](create-site.md), hai creato un sito demo basato sui modelli del componente aggiuntivo Demo di riferimento. Ora dovresti aver appreso quanto segue:
...
* Per esplorare solo i contenuti all’interno della console AEM Sites, inizia a esplorare e scopri di più nella sezione [Risorse aggiuntive](#additional-resources); non è richiesta alcuna ulteriore azione.
* Se desideri sperimentare le funzioni dinamiche complete di AEM Screens, continua nella sezione successiva, [Modifica dinamica del contenuto di Screens.](#dynamically-change)
...
Adesso sei pronto per esplorare le funzionalità di AEM Screens utilizzando i tuoi siti demo. Continua con la sezione successiva del percorso, [Gestire i siti demo](manage.md), dove verranno illustrati gli strumenti disponibili per aiutarti a gestire e a rimuovere i siti demo.
