...
Nel documento precedente del percorso di traduzione di AEM Sites, [Traduci contenuto,](configure-connector.md) hai imparato a utilizzare AEM progetti di traduzione per tradurre i contenuti. Ora dovresti:
...
1. Vai a **Navigazione** -> **Siti** -> **File** e apri la cartella del progetto.
...
Potete notare che le statistiche elencate sulla nuova scheda sono diverse. Questo perché AEM riconosce ciò che è cambiato dall&#39;ultima traduzione e include solo il contenuto che deve essere tradotto. Ciò include la ritraduzione dei contenuti aggiornati e la prima traduzione dei nuovi contenuti.
