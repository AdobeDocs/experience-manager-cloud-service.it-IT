...
Questo articolo si basa su tali principi fondamentali, in modo da poter effettuare il primo passaggio di configurazione e creare un nuovo sito da un modello che puoi personalizzare successivamente utilizzando gli strumenti front-end.

## Obiettivo {#objective}

Questo documento consente di comprendere come creare rapidamente un nuovo sito AEM utilizzando un modello di sito. Dopo la lettura dovresti:
...
1. Nella procedura guidata Crea sito, tocca o fai clic su **Importa** nella parte superiore della colonna a sinistra.
...
1. Una volta caricato, il modello viene visualizzato nell’elenco dei modelli disponibili. Tocca o fai clic su di esso per selezionarlo (rivelando anche informazioni sul modello nella colonna di destra), quindi tocca o fai clic su **Successivo**.
...
1. Tocca o fai clic su **Crea** e il nuovo sito verrà creato dal modello di sito.
...
1. Nel browser del sito individua la home page della lingua master, quindi tocca o fai clic sulla pagina per selezionarla, quindi tocca o fai clic su **Modifica** nella barra dei menu.
...
1. Tocca o fai clic sulla root del nuovo sito, quindi tocca o fai clic su **Scarica sorgenti del tema** nella barra del sito.
